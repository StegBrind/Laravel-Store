...
CKEDITOR.lang['ru'] = {
  ...
  "filetools": {
    ...
    "httpError404": "Ошибка HTTP при загрузке файла (404: Файл не найден)",
    "httpError403": "Ошибка HTTP при загрузке файла (403: Доступ запрещен)",
    "httpError": "Ошибка HTTP при загрузке файла (ошибка: %1).",
    "noUrlError": "URL-адрес загрузки не определен.",
  ...
  "youtube": {
    "button": "Вставка YouTube Video",
    "title": "Вставка YouTube Video",
    "txtEmbed": "Вставьте код видео",
    "txtUrl": "Вставьте ссылку YouTube Video",
    "txtWidth": "Ширина",
    "txtHeight": "Высота",
    "chkRelated": "Показывать похожие видео по окончанию",
    "txtStartAt": "Начать с (ss или mm:ss или hh:mm:ss)",
    "chkPrivacy": "Включить режим повышенной конфиденциальности",
    "chkOlderCode": "Использовать старый код для встраивания",
    "chkAutoplay": "Автовоспроизвидение",
    "chkControls": "Показать элементы управления",
    "noCode": "Вы должны ввести код вставки или URL-адрес",
    "invalidEmbed": "Код вставки, который вы ввели, не является действительным",
    "invalidUrl": "Введенный вами URL не является действительным",
    "or": "или",
    "noWidth": "Укажите ширину",
    "invalidWidth": "Укажите правильную ширину",
    "noHeight": "Укажите высоту",
    "invalidHeight": "Укажите правильную высоту",
    "invalidTime": "Укажите правильное время начала",
    "txtResponsive": "Responsive (игнорировать ширину и высоту, 100% ширины)",
    "txtNoEmbed": "Только изображение и ссылка"
  }
};
